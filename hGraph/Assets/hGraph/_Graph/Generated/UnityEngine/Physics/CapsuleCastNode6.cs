...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCast (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, RaycastHit hitInfo, Single maxDistance, Int32 layerMask)",
            Path = "UnityEngine/Physics/Methods/CapsuleCast",
            Deletable = true,
            Help = "CapsuleCast overload 6 of Physics"
        )]
        public class CapsuleCastNode6 : Node
        {
    ...
    [Input(Name = "layerMask", Editable = true)] public Int32 layerMask;
            ...
            {
                Boolean result = Physics.CapsuleCast(point1, point2, radius, direction, out hitInfo, maxDistance, layerMask);
                return result;
            }
        }
    }