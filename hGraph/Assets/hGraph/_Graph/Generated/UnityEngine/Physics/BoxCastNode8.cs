...
using System;
    ...
    {
        [Node(
            Name = "(Static) BoxCast (Vector3 center, Vector3 halfExtents, Vector3 direction, RaycastHit hitInfo, Quaternion orientation, Single maxDistance)",
            Path = "UnityEngine/Physics/Methods/BoxCast",
            Deletable = true,
            Help = "BoxCast overload 8 of Physics"
        )]
        public class BoxCastNode8 : Node
        {
    ...
    [Input(Name = "maxDistance", Editable = true)] public Single maxDistance;
            ...
            {
                Boolean result = Physics.BoxCast(center, halfExtents, direction, out hitInfo, orientation, maxDistance);
                return result;
            }
        }
    }