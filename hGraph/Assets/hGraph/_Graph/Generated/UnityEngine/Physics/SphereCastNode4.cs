...
using System;
    ...
    {
        [Node(
            Name = "(Static) SphereCast (Vector3 origin, Single radius, Vector3 direction, RaycastHit hitInfo)",
            Path = "UnityEngine/Physics/Methods/SphereCast",
            Deletable = true,
            Help = "SphereCast overload 4 of Physics"
        )]
        public class SphereCastNode4 : Node
        {
    ...
    [Input(Name = "hitInfo", Editable = true)] public RaycastHit hitInfo;
            ...
            {
                Boolean result = Physics.SphereCast(origin, radius, direction, out hitInfo);
                return result;
            }
        }
    }