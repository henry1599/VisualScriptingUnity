...
using System;
    ...
    {
        [Node(
            Name = "(Static) SphereCast (Ray ray, Single radius, Single maxDistance, Int32 layerMask, QueryTriggerInteraction queryTriggerInteraction)",
            Path = "UnityEngine/Physics/Methods/SphereCast",
            Deletable = true,
            Help = "SphereCast overload 5 of Physics"
        )]
        public class SphereCastNode5 : Node
        {
    ...
    [Input(Name = "queryTriggerInteraction", Editable = true)] public QueryTriggerInteraction queryTriggerInteraction;
            ...
            {
                Boolean result = Physics.SphereCast(ray, radius, maxDistance, layerMask, queryTriggerInteraction);
                return result;
            }
        }
    }