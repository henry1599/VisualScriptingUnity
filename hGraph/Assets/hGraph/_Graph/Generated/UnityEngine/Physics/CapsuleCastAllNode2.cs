...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCastAll (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, Single maxDistance, Int32 layerMask)",
            Path = "UnityEngine/Physics/Methods/CapsuleCastAll",
            Deletable = true,
            Help = "CapsuleCastAll overload 2 of Physics"
        )]
        public class CapsuleCastAllNode2 : Node
        {
    ...
    [Input(Name = "layerMask", Editable = true)] public Int32 layerMask;
            ...
            {
                RaycastHit[] result = Physics.CapsuleCastAll(point1, point2, radius, direction, maxDistance, layerMask);
                return result;
            }
        }
    }