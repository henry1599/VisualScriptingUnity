...
using System;
    ...
    {
        [Node(
            Name = "(Static) BoxCastNonAlloc (Vector3 center, Vector3 halfExtents, Vector3 direction, RaycastHit[] results, Quaternion orientation, Single maxDistance, Int32 layerMask, QueryTriggerInteraction queryTriggerInteraction)",
            Path = "UnityEngine/Physics/Methods/BoxCastNonAlloc",
            Deletable = true,
            Help = "BoxCastNonAlloc overload 1 of Physics"
        )]
        public class BoxCastNonAllocNode1 : Node
        {
    ...
    [Input(Name = "queryTriggerInteraction", Editable = true)] public QueryTriggerInteraction queryTriggerInteraction;
            ...
            {
                Int32 result = Physics.BoxCastNonAlloc(center, halfExtents, direction, results, orientation, maxDistance, layerMask, queryTriggerInteraction);
                return result;
            }
        }
    }