...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCast (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, Single maxDistance)",
            Path = "UnityEngine/Physics/Methods/CapsuleCast",
            Deletable = true,
            Help = "CapsuleCast overload 3 of Physics"
        )]
        public class CapsuleCastNode3 : Node
        {
    ...
    [Input(Name = "maxDistance", Editable = true)] public Single maxDistance;
            ...
            {
                Boolean result = Physics.CapsuleCast(point1, point2, radius, direction, maxDistance);
                return result;
            }
        }
    }