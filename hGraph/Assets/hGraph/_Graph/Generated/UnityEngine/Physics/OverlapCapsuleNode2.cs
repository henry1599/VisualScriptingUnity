...
using System;
    ...
    {
        [Node(
            Name = "(Static) OverlapCapsule (Vector3 point0, Vector3 point1, Single radius, Int32 layerMask)",
            Path = "UnityEngine/Physics/Methods/OverlapCapsule",
            Deletable = true,
            Help = "OverlapCapsule overload 2 of Physics"
        )]
        public class OverlapCapsuleNode2 : Node
        {
    ...
    [Input(Name = "layerMask", Editable = true)] public Int32 layerMask;
            ...
            {
                Collider[] result = Physics.OverlapCapsule(point0, point1, radius, layerMask);
                return result;
            }
        }
    }