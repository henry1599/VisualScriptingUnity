...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCastAll (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, Single maxDistance, Int32 layerMask, QueryTriggerInteraction queryTriggerInteraction)",
            Path = "UnityEngine/Physics/Methods/CapsuleCastAll",
            Deletable = true,
            Help = "CapsuleCastAll overload 1 of Physics"
        )]
        public class CapsuleCastAllNode1 : Node
        {
    ...
    [Input(Name = "queryTriggerInteraction", Editable = true)] public QueryTriggerInteraction queryTriggerInteraction;
            ...
            {
                RaycastHit[] result = Physics.CapsuleCastAll(point1, point2, radius, direction, maxDistance, layerMask, queryTriggerInteraction);
                return result;
            }
        }
    }