...
using System;
    ...
    {
        [Node(
            Name = "(Static) SphereCastNonAlloc (Ray ray, Single radius, RaycastHit[] results, Single maxDistance)",
            Path = "UnityEngine/Physics/Methods/SphereCastNonAlloc",
            Deletable = true,
            Help = "SphereCastNonAlloc overload 7 of Physics"
        )]
        public class SphereCastNonAllocNode7 : Node
        {
    ...
    [Input(Name = "maxDistance", Editable = true)] public Single maxDistance;
            ...
            {
                Int32 result = Physics.SphereCastNonAlloc(ray, radius, results, maxDistance);
                return result;
            }
        }
    }