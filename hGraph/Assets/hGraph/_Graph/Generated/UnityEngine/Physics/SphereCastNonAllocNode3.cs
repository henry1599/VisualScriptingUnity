...
using System;
    ...
    {
        [Node(
            Name = "(Static) SphereCastNonAlloc (Vector3 origin, Single radius, Vector3 direction, RaycastHit[] results, Single maxDistance)",
            Path = "UnityEngine/Physics/Methods/SphereCastNonAlloc",
            Deletable = true,
            Help = "SphereCastNonAlloc overload 3 of Physics"
        )]
        public class SphereCastNonAllocNode3 : Node
        {
    ...
    [Input(Name = "maxDistance", Editable = true)] public Single maxDistance;
            ...
            {
                Int32 result = Physics.SphereCastNonAlloc(origin, radius, direction, results, maxDistance);
                return result;
            }
        }
    }