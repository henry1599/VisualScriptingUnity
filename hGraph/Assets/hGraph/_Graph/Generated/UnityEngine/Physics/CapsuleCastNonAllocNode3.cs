...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCastNonAlloc (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, RaycastHit[] results, Single maxDistance)",
            Path = "UnityEngine/Physics/Methods/CapsuleCastNonAlloc",
            Deletable = true,
            Help = "CapsuleCastNonAlloc overload 3 of Physics"
        )]
        public class CapsuleCastNonAllocNode3 : Node
        {
    ...
    [Input(Name = "maxDistance", Editable = true)] public Single maxDistance;
            ...
            {
                Int32 result = Physics.CapsuleCastNonAlloc(point1, point2, radius, direction, results, maxDistance);
                return result;
            }
        }
    }