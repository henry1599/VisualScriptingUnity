...
using System;
    ...
    {
        [Node(
            Name = "(Static) SphereCastAll (Vector3 origin, Single radius, Vector3 direction)",
            Path = "UnityEngine/Physics/Methods/SphereCastAll",
            Deletable = true,
            Help = "SphereCastAll overload 4 of Physics"
        )]
        public class SphereCastAllNode4 : Node
        {
    ...
    [Input(Name = "direction", Editable = true)] public Vector3 direction;
            ...
            {
                RaycastHit[] result = Physics.SphereCastAll(origin, radius, direction);
                return result;
            }
        }
    }