...
using System;
    ...
    {
        [Node(
            Name = "(Static) OverlapBox (Vector3 center, Vector3 halfExtents, Quaternion orientation, Int32 layerMask, QueryTriggerInteraction queryTriggerInteraction)",
            Path = "UnityEngine/Physics/Methods/OverlapBox",
            Deletable = true,
            Help = "OverlapBox overload 1 of Physics"
        )]
        public class OverlapBoxNode1 : Node
        {
    ...
    [Input(Name = "queryTriggerInteraction", Editable = true)] public QueryTriggerInteraction queryTriggerInteraction;
            ...
            {
                Collider[] result = Physics.OverlapBox(center, halfExtents, orientation, layerMask, queryTriggerInteraction);
                return result;
            }
        }
    }