...
using System;
    ...
    {
        [Node(
            Name = "(Static) CapsuleCast (Vector3 point1, Vector3 point2, Single radius, Vector3 direction, RaycastHit hitInfo)",
            Path = "UnityEngine/Physics/Methods/CapsuleCast",
            Deletable = true,
            Help = "CapsuleCast overload 8 of Physics"
        )]
        public class CapsuleCastNode8 : Node
        {
    ...
    [Input(Name = "hitInfo", Editable = true)] public RaycastHit hitInfo;
            ...
            {
                Boolean result = Physics.CapsuleCast(point1, point2, radius, direction, out hitInfo);
                return result;
            }
        }
    }