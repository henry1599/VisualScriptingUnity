...
using System;
    ...
    {
        [Node(
            Name = "(Static) Linecast (Vector3 start, Vector3 end, RaycastHit hitInfo)",
            Path = "UnityEngine/Physics/Methods/Linecast",
            Deletable = true,
            Help = "Linecast overload 6 of Physics"
        )]
        public class LinecastNode6 : Node
        {
    ...
    [Input(Name = "hitInfo", Editable = true)] public RaycastHit hitInfo;
            ...
            {
                Boolean result = Physics.Linecast(start, end, out hitInfo);
                return result;
            }
        }
    }