...
using System;
    ...
    {
        [Node(
            Name = "(Static) Linecast (Vector3 start, Vector3 end, RaycastHit hitInfo, Int32 layerMask, QueryTriggerInteraction queryTriggerInteraction)",
            Path = "UnityEngine/Physics/Methods/Linecast",
            Deletable = true,
            Help = "Linecast overload 4 of Physics"
        )]
        public class LinecastNode4 : Node
        {
    ...
    [Input(Name = "queryTriggerInteraction", Editable = true)] public QueryTriggerInteraction queryTriggerInteraction;
            ...
            {
                Boolean result = Physics.Linecast(start, end, out hitInfo, layerMask, queryTriggerInteraction);
                return result;
            }
        }
    }