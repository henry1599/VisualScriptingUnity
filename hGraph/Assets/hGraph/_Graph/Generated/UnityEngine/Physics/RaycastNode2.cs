...
using System;
    ...
    {
        [Node(
            Name = "(Static) Raycast (Vector3 origin, Vector3 direction, Single maxDistance, Int32 layerMask)",
            Path = "UnityEngine/Physics/Methods/Raycast",
            Deletable = true,
            Help = "Raycast overload 2 of Physics"
        )]
        public class RaycastNode2 : Node
        {
    ...
    [Input(Name = "layerMask", Editable = true)] public Int32 layerMask;
            ...
            {
                Boolean result = Physics.Raycast(origin, direction, maxDistance, layerMask);
                return result;
            }
        }
    }