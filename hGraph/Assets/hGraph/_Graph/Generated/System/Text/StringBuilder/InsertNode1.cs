...
using System;
    ...
    {
        [Node(
            Name = "Insert (Int32 index, String value, Int32 count)",
            Path = "System.Text/StringBuilder/Methods/Insert",
            Deletable = true,
            Help = "Insert overload 1 of StringBuilder"
        )]
        public class InsertNode1 : Node
        {
    ...
    [Input(Name = "count", Editable = true)] public Int32 count;
            ...
            {
                StringBuilder result = stringbuilder.Insert(index, value, count);
                return result;
            }
        }
    }