...
using System;
    ...
    {
        [Node(
            Name = "CopyTo (Int32 sourceIndex, String destination, Int32 count)",
            Path = "System.Text/StringBuilder/Methods/CopyTo",
            Deletable = true,
            Help = "CopyTo overload 2 of StringBuilder"
        )]
        public class CopyToNode2 : Node
        {
    ...
    [Input(Name = "destination", Editable = true)] public String destination;
    [Input(Name = "count", Editable = true)] public Int32 count;
            ...
            {
                stringbuilder.CopyTo(sourceIndex, destination.ToCharArray(), count);
                return exit;
            }
        }
    }