...
using System.Collections.Generic;
    ...
    {
        [Node(
            Name = "AppendFormat (String format, object arg0, object arg1, object arg2)",
            Path = "System.Text/StringBuilder/Methods/AppendFormat",
            Deletable = true,
            Help = "AppendFormat overload 3 of StringBuilder"
        )]
        public class AppendFormatNode3 : Node
        {
    ...
    [Input(Name = "arg2", Editable = true)] public object arg2;
            ...
            {
                StringBuilder result = stringbuilder.AppendFormat(format, arg0, arg1, arg2);
                return result;
            }
        }
    }