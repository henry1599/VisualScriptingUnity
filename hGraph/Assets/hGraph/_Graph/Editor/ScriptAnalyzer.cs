...
public class RoslynScriptAnalyzer : EditorWindow
{
    ...
    private void AnalyzeScript(string path)
    {
        ...
        foreach (var (className, classNode) in parsedScript.Classes)
        {
            ...
            // Extract methods
            foreach (var methodNode in parsedScript.Classes[className].Methods)
            {
            ...
            // Extract fields
            foreach (var fieldNode in parsedScript.Classes[className].Fields)
            {
