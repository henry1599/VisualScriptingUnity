...
public class FlexibleColorPicker : MonoBehaviour
{
    ...
    */
    ...
    [SerializeField] Toggle _colorPreviewToggle;
    ...
    */
    ...
    private void Awake()
    {
        ...
        _colorPreviewToggle.onValueChanged.AddListener(OnColorPreviewToggle);
    }

    private void OnColorPreviewToggle(bool isOn)
    {
        if (!isOn)
            return;
        SetColor(CSPaintingManager.Instance.CuurentColor);
    }
    void OnDestroy()
    {
        _colorPreviewToggle.onValueChanged.RemoveListener(OnColorPreviewToggle);
    }
